...
.DESCRIPTION
    ...
    then re-runs onboarding with the exact choices you normally type interactively:
      ...
      - API key:       test
      - Compatibility: Anthropic-compatible (/v1/messages)
...
.NOTES
    ...
    Usage:
      .\scripts\setup-openclaw-test-anthropic-claude-haiku.ps1
      .\scripts\setup-openclaw-test-anthropic-claude-haiku.ps1 -Reinstall
      .\scripts\setup-openclaw-test-anthropic-claude-haiku.ps1 -BaseUrl "http://127.0.0.1:8081/" -ApiKey "my-key"
#>
